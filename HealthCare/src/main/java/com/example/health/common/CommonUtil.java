...
public class CommonUtil {
	...
	public static boolean isNullString(String str) {
		if(null == str || Constant.BLANK.equals(str)) {
			return true;
		}
		return false;
	}
	...
	/**
	 * String 변수 not null 체크
	 * @param str
	 * @return true: 빈 값이 아닐경우, false: 빈 값일 경우
	 * 
	 * @author yeong
	 */
	...
	/**
	 * String 변수 2개가 일치하거나 포함하지 않는지 파악
	 * @param str1
	 * @param str2
	 * @return true : 두 변수가 일치 혹은 포함하지 않음, false : 두 변수가 일치 혹은 포함
	 * 
	 * @author yeong
	 */
	 ...
	 * @param str1
	 * @param str2
	 * @return true : 두 변수가 일치하지 않음, false : 두 변수가 같음
	 * 
	 * @author yeong
	 */
